...
open class TTGSnackbar: UIView {
    ...
    fileprivate var secondSeperateView: UIView!
...
public extension TTGSnackbar {
    ...
    public func show() {
        ...
        secondSeperateView.isHidden = secondActionButton.isHidden
...
private extension TTGSnackbar {
    func configure() {
        ...
        // Add constraints
        let secondSeperateConstraints = secondSeperateView.isHidden ? "0" : "2-[secondSeperateView(0.5)]-2"
        let hConstraints: [NSLayoutConstraint] = NSLayoutConstraint.constraints(
        withVisualFormat: "H:|-0-[iconImageView]-2-[messageLabel]-2-[seperateView(0.5)]-2-[actionButton]-\(secondSeperateConstraints)-[secondActionButton]-0-|",
                options: NSLayoutFormatOptions(rawValue: 0),
                metrics: nil,
                views: ["iconImageView": iconImageView, "messageLabel": messageLabel, "seperateView": separateView, "actionButton": actionButton, "secondSeperateView": secondSeperateView, "secondActionButton": secondActionButton])
        ...
        let vConstraintsForSecondSeperateView: [NSLayoutConstraint] = NSLayoutConstraint.constraints(
            withVisualFormat: "V:|-4-[secondSeperateView]-4-|",
            options: NSLayoutFormatOptions(rawValue: 0),
            metrics: nil,
        ...
        contentView.addConstraints(vConstraintsForSecondSeperateView)
...
private extension TTGSnackbar {
    ...
    @objc func doAction(_ button: UIButton) {
        ...
        if (duration == .forever || showActionActivity || showActionPostMessage) && actionButton.isHidden == false {
            actionButton.isHidden = true
            secondActionButton.isHidden = true
            separateView.isHidden = true
            secondSeperateView.isHidden = true
